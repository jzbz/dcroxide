...
| `redb` | 2.6.3 | chain metadata store | accepted, [ADR-0004](adr/0004-storage-backend.md) | ~30k lines of Rust. Chosen for crash-safety without a C toolchain; its commit shape is the tracked cost. Read closely in one respect — the free-page and transaction-tracker behaviour analysed in ADR-0004's 2026-08-07 addendum — but not reviewed as a whole. |
